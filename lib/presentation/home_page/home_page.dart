...
class HomeState extends State<HomePage>{
  ...
  final drawerItems = [
    ...
    new DrawerItem(id:"3",title:"Explore", icon:"search.png",isSelected: false),
    new DrawerItem(id:"4",title:"Map", icon:"map.png",isSelected: false),
    new DrawerItem(id:"5",title:"Mess Menu", icon:"mess.png",isSelected: false),
  ...
  Widget build(BuildContext context) {
    ...
    for (var i = 0; i < drawerItems.length; i++) {
      ...
      drawerOptions.add(new Container(
        child: new ListTile(
          leading:d.isSelected? Image.asset(d.icon,color:LightColors.white):Image.asset(d.icon,color: LightColors.darkGrey,),
          title: new Text(
            d.title,
            style:d.isSelected? new TextStyle(color:LightColors.white,fontSize: 16)
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(_title,style: TextStyle(color: LightColors.black),),
      ),
      drawer: Drawer(
            ...
            child: Column(
              children: [
                Container(
                  ...
                  height: MediaQuery.of(context).orientation==Orientation.landscape?MediaQuery.of(context).size.height*0.3
                  ...
                  child:Row(
                    ...
                    children: [
                      ...
                      SizedBox(width:10,),
                      Text(widget.user,style: TextStyle(color: LightColors.black,fontWeight: FontWeight.bold,fontSize: 18),),
                    ],
                  ),
                ),
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: <BottomNavigationBarItem>[
          new BottomNavigationBarItem(icon:  Image.asset("feed.png"),title: Text(""),activeIcon:CircleAvatar(child: Image.asset("feed.png",color: Theme.of(context).primaryColor,),backgroundColor: Colors.black,)),
          new BottomNavigationBarItem(icon: Image.asset("news.png"),title: Text(""),activeIcon:CircleAvatar(child:Image.asset("news.png",color: Theme.of(context).primaryColor,),backgroundColor: Colors.black,)),
          new BottomNavigationBarItem(icon: Image.asset("search.png"),title: Text(""),activeIcon:CircleAvatar(child: Image.asset("search.png",color: Theme.of(context).primaryColor,),backgroundColor: Colors.black,)),
          new BottomNavigationBarItem(icon: Image.asset("map.png"),title: Text(""),activeIcon:CircleAvatar(child: Image.asset("map.png",color: Theme.of(context).primaryColor,),backgroundColor: Colors.black,)),
        ],
      ),
    );
  }
